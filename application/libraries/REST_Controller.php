 ...
 * @category        Libraries
 * @author          Phil Sturgeon, Chris Kacerguis, Abyan Ahmad Fathin
 * @license         MIT
...
abstract class REST_Controller extends CI_Controller
{
    ...
    const api_local = "localhost/test/";
    const app_local = "http://localhost/btest/";
    const delimiter_paragraph = '/(\s*<(\/?p)\s*\/?>\s*)+/u'; #preg_split pattern delimiter
    ...
    const HTTP_FORBIDDEN_MESSAGE = "INVALID AUTHENTICATIONS OR FORBIDDEN";
    ...
    const HTTP_NOT_FOUND_MESSAGE = "DATA NOT FOUND";
     ...
     */
    public function response($data = NULL, $http_code = NULL, $continue = FALSE, $header_key = NULL)
    {
        ...
        if (!$isProfilingEnabled) {
            ...
            $this->output->set_header('BABOO-AUTH-KEY: ' . $header_key);
     ...
     * @param int|NULL $http_code HTTP status code
     */
    public function set_response($data = NULL, $http_code = self::HTTP_OK, $http_key = "")
    {
        $this->response($data, $http_code, TRUE, $http_key);
    }
